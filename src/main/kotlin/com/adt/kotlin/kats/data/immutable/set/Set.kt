...
import com.adt.kotlin.kats.data.immutable.set.Set.SetProxy
import com.adt.kotlin.kats.data.immutable.set.SetF.balance
import com.adt.kotlin.kats.data.immutable.set.SetF.bin
import com.adt.kotlin.kats.data.immutable.set.SetF.empty
import com.adt.kotlin.kats.data.immutable.set.SetF.fromList
import com.adt.kotlin.kats.data.immutable.set.SetF.glue
import com.adt.kotlin.kats.data.immutable.set.SetF.hedgeDifference
import com.adt.kotlin.kats.data.immutable.set.SetF.hedgeUnion
import com.adt.kotlin.kats.data.immutable.set.SetF.join
import com.adt.kotlin.kats.data.immutable.set.SetF.merge
import com.adt.kotlin.kats.data.immutable.set.SetF.splitLookup
import com.adt.kotlin.kats.data.immutable.set.SetF.toList
import com.adt.kotlin.kats.data.instances.monoid.SetMonoid
import com.adt.kotlin.kats.data.instances.semigroup.SetSemigroup
...
typealias SetOf<A> = Kind1<SetProxy, A>

sealed class Set<A : Comparable<A>>(val size: Int) : Kind1<SetProxy, A> {

    class SetProxy private constructor()



    internal object Tip : Set<Nothing>(0)
    ...
    companion object {
         ...
         */
        fun <A : Comparable<A>> semigroup(): Semigroup<Set<A>> = object: SetSemigroup<A> {}

        /**
         * Create an instance of this monoid.
         */
        fun <A : Comparable<A>> monoid(): Monoid<Set<A>> = SetMonoid()
