...
object MapF {
    ...
    fun <K : Comparable<K>, V> fromSequenceWithKey(f: (K) -> (V) -> (V) -> V, vararg seq: Pair<K, V>): Map<K, V> {
        ...
        var pairs: com.adt.kotlin.kats.data.immutable.list.List<Pair<K, V>> = ListF.empty<Pair<K, V>>()
     ...
     * @return			the required map
     */
    fun <K : Comparable<K>, V> fromListWith(xs: com.adt.kotlin.kats.data.immutable.list.List<Pair<K, V>>, f: (V) -> (V) -> V): Map<K, V> =
     ...
     * @return			the required map
     */
    fun <K : Comparable<K>, V> fromListWith(xs: com.adt.kotlin.kats.data.immutable.list.List<Pair<K, V>>, f: (V, V) -> V): Map<K, V> = fromListWith(xs, C2(f))
     ...
     * @return			the required map
     */
    fun <K : Comparable<K>, V> fromListWithKey(xs: com.adt.kotlin.kats.data.immutable.list.List<Pair<K, V>>, f: (K) -> (V) -> (V) -> V): Map<K, V> {
        val insert: (Map<K, V>) -> (Pair<K, V>) -> Map<K, V> = { map -> { pair -> map.insertWithKey(pair.first, pair.second, f)}}
     ...
     * @return			the required map
     */
    fun <K : Comparable<K>, V> fromListWithKey(xs: com.adt.kotlin.kats.data.immutable.list.List<Pair<K, V>>, f: (K, V, V) -> V): Map<K, V> = fromListWithKey(xs, C3(f))
